...
L.Control.Weather = L.Control.extend({
    ...
    refresh: function(callback) {
        var _this = this,
            ...
            url = `http://api.openweathermap.org/data/2.5/weather?APPID=${this.options.apiKey}&lat=${center.lat}&lon=${center.lng}&lang=${this.options.lang}&units=${this.options.units}`;
