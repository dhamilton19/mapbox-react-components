...
var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
	filename: 'components/Controls/Control.jsx',
...
var Control = _wrapComponent('Control')(function (_Component) {
	...
	_createClass(Control, [{
		...
		value: function componentWillReceiveProps(props) {
			...
			var options = (0, _omit2.default)(this.props, ['map']);
		...
		value: function addControl(options, map) {
			if (map && !this.control) {
				this.control = new _mapbox2.default.Control[this.getType()](options).addTo(map);
			}
		}
	}, {
		key: 'render',
