...
var Map = function (_Component) {
    ...
    _createClass(Map, [{
        ...
        value: function componentDidMount() {
            ...
            _lodash2.default.omit(options, _lodash2.default.isNull);

            var map = _mapbox2.default.mapbox.map(document.getElementById('map'), layer, options);
            if (zoomControlPosition) new _mapbox2.default.Control.Zoom({ position: zoomControlPosition }).addTo(map);

            this.markerLayer = _mapbox2.default.mapbox.featureLayer().addTo(map);
